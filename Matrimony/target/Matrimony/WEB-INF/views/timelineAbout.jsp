            ...
            <div class="row">
              ...
              <div class="col-md-9">
                <ul class="list-inline profile-menu">
                  <li><a href="<c:url value="/" />">Timeline</a></li>
                  <li><a href="<c:url value="/userInfo" />" class="active">About</a></li>
              ...
              <div class="about-profile">
                ...
                <div class="about-content-block">
                  ...
                  <div class="organization">
                    <img src="<c:url value='/static/images/envato.png' />" alt="" class="pull-left img-org" />
                    <div class="work-info">
                      <h5>Martial Status</h5>
                      <p><span class="text-grey">${userinfo.martialStatus}</span></p>
                    </div>
                  </div>
                  <div class="organization">
                    <img src="<c:url value='/static/images/envato.png' />" alt="" class="pull-left img-org" />
                    <div class="work-info">
                      <h5>Religion</h5>
                      <p><span class="text-grey">${userinfo.religion}</span></p>
                    </div>
                  </div>
                  <div class="organization">
                    <img src="<c:url value='/static/images/envato.png' />" alt="" class="pull-left img-org" />
                    <div class="work-info">
                      ...
                      <p><span class="text-grey">${userinfo.contactNumber}</span></p>
                    </div>
                  </div>
                </div>
                <div class="about-content-block">
                ...
                <div class="about-content-block">
                  <h4 class="grey"><i class="ion-ios-chatbubble-outline icon-in-title"></i>Language</h4>
                    <ul>
                      <li><a href="">${userinfo.motherTongue}</a></li>
