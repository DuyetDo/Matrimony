...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
    ...
    ================================================= -->
        ...
        <link rel="stylesheet" href="<c:url value='/static/css/emoji.css' />" />
    <!--Google Webfont-->
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <form class="navbar-form navbar-right hidden-sm">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="dddd" placeholder="Search friends, photos, videos">
                <a href="#" onclick='window.location = "/search-user-" + $('#dddd').val()'><span class="glyphicon glyphicon-search"></span></a>
              </div>
            </form>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container -->
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="profile-info">
                  <img src="<c:url value='/static/images/users/user-21.jpg' />" alt="" class="img-responsive profile-photo" />
                  <h3>${loggedinuser}</h3>
              ...
              <div class="col-md-9">
                <ul class="list-inline profile-menu">
                  <li><a href="<c:url value="/" />" class="active">Timeline</a></li>
                  <li><a href="<c:url value="/userInfo" />">About</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <div class="create-post">
                <div class="row">
                  <div class="col-md-7 col-sm-7">
                    <div class="form-group">
                      <img src="<c:url value='/static/images/users/user-21.jpg' />" alt="" class="profile-photo-md" />
              ...
              <div class="post-content">
                ...
                <img src="<c:url value='/static/images/post-images/12.jpg' />" alt="post-image" class="img-responsive post-image" />
                <div class="post-container">
                  ...
                  <div class="post-detail">
                    ...
                    <div class="post-comment">
                      <img src="<c:url value='/static/images/users/user-11.jpg' />" alt="" class="profile-photo-sm" />
                      <p><a href="timeline.html" class="profile-link">Diana </a><i class="em em-laughing"></i> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud </p>
                    </div>
                    <div class="post-comment">
                      <img src="<c:url value='/static/images/users/user-4.jpg' />" alt="" class="profile-photo-sm" />
                      <p><a href="timeline.html" class="profile-link">John</a> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud </p>
                    </div>
                    <div class="post-comment">
                      <img src="<c:url value='/static/images/users/user-19.jpg' />" alt="" class="profile-photo-sm" />
              ...
              <div class="post-content">
                ...
                <img src="<c:url value='/static/images/post-images/13.jpg' />" alt="post-image" class="img-responsive post-image" />
                <div class="post-container">
                  <img src="images/users/user-19.jpg" alt="user" class="profile-photo-md pull-left" />
                  <div class="post-detail">
                    <div class="user-info">
                      <h5><a href="timeline.html" class="profile-link">Sarah Cruiz</a> <span class="following">following</span></h5>
                    ...
                    <div class="post-comment">
                      <img src="<c:url value='/static/images/users/user-1.jpg' />" alt="" class="profile-photo-sm" />
                      <input type="text" class="form-control" placeholder="Post a comment">
                    </div>
                  </div>
                </div>
              ...
              <div class="post-content">
                ...
                <div class="post-container">
                  <img src="<c:url value='/static/images/users/user-1.jpg' />" alt="user" class="profile-photo-md pull-left" />
                  <div class="post-detail">
                    <div class="user-info">
                      <h5><a href="timeline.html" class="profile-link">Sarah Cruiz</a> <span class="following">following</span></h5>
