package com.fpt.aptech.matrimony.configuration;
...
@ComponentScan({ "com.fpt.aptech.matrimony.configuration" })
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.fpt.aptech.matrimony.model" });
